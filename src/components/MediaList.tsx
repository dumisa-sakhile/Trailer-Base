    ...
    <section className="w-full flex flex-col items-start justify-center gap-4 ">
      <div className="w-full flex items-center justify-between px-4">
        ...
        <Link
          ...
          params={{ list: list }}
          search={{ page: 1 }}>
          <button className="px-3 py-1.5 text-sm font-medium text-white bg-blue-700 backdrop-blur-md rounded-md hover:bg-blue-900/80 hover:text-white transition-all duration-300">
            View All {title}
          </button>
        </Link>
      </div>
