...
const Footer: React.FC = () => {
  return (
    <footer className="bg-[#333]/50 backdrop-blur-md text-base text-gray-100 rounded-lg shadow-sm m-4 roboto-condensed-light md:geist-regular text-center mx-auto max-w-[calc(100vw-4vw)] md:max-w-[1100px]">
