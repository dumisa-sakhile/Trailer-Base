  ...
  return (
    ...
    <title>Trailer Base - Movie Details</title>
      <img
        ...
        src="	https://image.tmdb.org/t/p/original//zGLQmrmIB56kMZPnzqReIOBay1B.jpg"
      />
      ...
      <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-t from-black pt-[15%] p-4 md:pl-10 lg:pl-20 flex flex-col gap-8 pb-10">
        ...
        <BackHomeBtn/>
        <img
          src="https://image.tmdb.org/t/p/w500//m2v7e28s8pOR5MphTdzGN2UDpb8.png"
          alt="fff"
        ...
        <article className="flex items-center gap-4 geist-regular text-lg">
          <p className="flex items-center gap-2">
            Released: <span className="text-[#FACC15]">2024-09-12</span>
          </p>
          <p className="flex items-center gap-2">
            <svg
              aria-hidden="true"
            ...
            <span className="text-[#FACC15]">6.5/10</span>
          </p>
          <p className="flex items-center gap-2">
            Duration: <span className="text-[#FACC15]">1h 44m</span>
          </p>
        </article>

        {/* description */}
        <p className="text-white text-md roboto-condensed-regular w-full md:w-1/2 lg:w-1/2 bg-[rgba(0,0,0,0.2)] backdrop-blur-sm rounded px-4 py-6 rounded-lg ring-1 ring-gray-900/50 hover:ring-gray-00/50 transition duration-300 ease-in-out transform">
          <span className="font-bold">Description:&nbsp;</span> When top hitman
          Joe Flood is diagnosed with a terminal illness, he decides to take
          matters into his own hands – by taking a hit out on himself. But when
          the very hitmen he hired also target his ex-girlfriend, he must fend
          off an army of assassin colleagues and win back the love of his life
